...
class ChattownWidget extends StatefulWidget {
  const ChattownWidget({Key key}) : super(key: key);

  @override
  _ChattownWidgetState createState() => _ChattownWidgetState();
}

class _ChattownWidgetState extends State<ChattownWidget> {
