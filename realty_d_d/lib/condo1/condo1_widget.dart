...
class Condo1Widget extends StatefulWidget {
  const Condo1Widget({Key key}) : super(key: key);

  @override
  _Condo1WidgetState createState() => _Condo1WidgetState();
}

class _Condo1WidgetState extends State<Condo1Widget> {
